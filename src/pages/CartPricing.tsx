...
const FREE_FEATURES: PlanFeature[] = [
  ...
  { text: "Carte interactive complete", included: true },
  { text: "5 packs d'analyse IA", included: true },
  { text: "Quick wins (apercu)", included: true },
  { text: "Packs 6 a 10", included: false },
  { text: "Diagnostic complet", included: false },
