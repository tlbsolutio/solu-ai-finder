...
const translations = {
  fr: {
    ...
    'home.hero_btn_tools': 'Découvrir les outils',
    ...
    'home.acc_step1_title': 'Diagnostic',
    'home.acc_step1_desc': 'Comprendre comment l\'organisation fonctionne réellement — flux, outils, pertes de temps, irritants. Cartographier ce qui existe avant de proposer quoi que ce soit.',
    'home.acc_step2_title': 'Conception',
    'home.acc_step2_desc': 'Définir précisément ce qu\'il faut construire, configurer ou changer. Architecture technique, choix d\'outils, périmètre — tout est cadré avant de commencer.',
    'home.acc_step3_title': 'Construction',
    'home.acc_step3_desc': 'Développement sur mesure, configuration, intégrations, automatisations. Le livrable peut être un outil, un système, une formation — ce qui résout le problème.',
    'home.acc_step4_title': 'Adoption',
    'home.acc_step4_desc': 'Former les équipes, ajuster ce qui doit l\'être, s\'assurer que ce qui a été livré est réellement utilisé au quotidien. Pas de livraison sans suivi.',

    // Conviction
    'home.conv_label': 'Conviction',
    'home.conv_title': 'La valeur d\'un expert se mesure à ce qu\'il accomplit. Une heure du bon professionnel vaut deux semaines d\'un autre.',
    ...
    // FAQ
    'home.faq_label': 'FAQ',
    'home.faq_title': 'Questions',
    'home.faq_title_accent': 'fréquentes',
