...
const translations = {
  fr: {
    ...
    'problem.stat_source': 'Étude de marché 2024',
    ...
    'proof.stat1_source': 'Étude sectorielle 2024',
    'proof.stat2': '+40%',
    'proof.stat2_detail': 'de productivité avec des processus bien cartographiés',
    'proof.stat2_source': 'Analyse terrain',
    'proof.stat3': '3x',
    ...
    'home.hero_btn_work': 'Discuter d\'un projet',
    ...
    'home.acc_p1': 'Diagnostiquer, prioriser, implémenter, former. Solutio accompagne les PME de la cartographie de leurs dysfonctionnements jusqu\'à la mise en production des solutions.',
    'home.acc_p2': 'L\'intervention cible ce qui bloque vraiment — pas ce qui est confortable à adresser. Et le départ se fait quand c\'est en marche, pas quand la mission est terminée sur le papier.',
    ...
    'home.acc_step1_desc': 'Cartographier ce qui existe avant de proposer quoi que ce soit. Cartographie des processus, identification des friction points, hiérarchisation par impact.',
    ...
    'home.acc_step3_desc': 'Le livrable peut être un outil, un système, une formation — ce qui résout le problème. Le résultat compte — pas les slides.',
    ...
    'home.conv_title': 'La valeur d\'un expert se mesure',
    'home.conv_title_accent': 'à ce qu\'il accomplit.',
    'home.conv_quote': 'Une heure du bon professionnel vaut deux semaines d\'un autre. Ce n\'est pas une question de temps — c\'est une question de maîtrise.',
    'home.conv_p1': 'Vision, stratégie, exécution — c\'est là que se crée ce qu\'aucun système ne peut remplacer. Tout le reste peut et devrait être pris en charge par la technologie.',
    'home.conv_p2': 'Quand les outils sont construits pour un contexte précis, ils absorbent ce qui n\'aurait jamais dû requérir de l\'attention humaine. Ce temps revient là où il a de la valeur.',
    ...
    'home.faq1_a': 'Solutio travaille avec des indépendants, des équipes de 5 personnes, et des structures de 50+. Ce qui compte ce n\'est pas la taille — c\'est l\'ambition de bien s\'organiser et la volonté de changer ce qui ne fonctionne pas.',
    'home.faq2_q': 'Quelle est la différence avec un consultant classique ?',
    'home.faq2_a': 'Pas de rapport livré puis oublié. L\'engagement dure jusqu\'à ce que la solution soit en production et adoptée par les équipes. Et quand c\'est pertinent, les outils sont construits sur mesure plutôt que de recommander des licences.',
    'home.faq3_q': 'Combien de temps ça prend ?',
    'home.faq3_a': 'Le diagnostic initial prend quelques jours. La mise en œuvre dépend du périmètre — quelques semaines pour un système ciblé, quelques mois pour une transformation plus large. Le cadre est défini ensemble avant de commencer.',
    ...
    'home.dcta_consult_sub': 'Un échange sur votre organisation, vos besoins, ce qui peut être construit ensemble.',
    'home.dcta_consult_btn': 'Réserver un échange',

    // Footer
    'footer.tagline': 'Conseil en transformation digitale. Diagnostic, outils sur mesure et accompagnement.',
  ...
  en: {
    ...
    'problem.stat_source': 'Market study 2024',
