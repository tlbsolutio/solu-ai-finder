...
const translations = {
  fr: {
    ...
    'home.real1_metric': '1 outil',
    'home.real1_metric_label': 'au lieu de 6',
    'home.real1_before': '40+ consultants, outils non connectés, suivi sur tableur. La coordination absorbait le temps qu\'ils auraient dû passer sur leurs missions.',
    'home.real1_after': 'Suite applicative intégrée. Un seul endroit pour les missions, les temps, les livrables. Les consultants font leur métier — plus de l\'administration.',
  ...
  en: {
    ...
    'home.real1_metric': '1 tool',
    'home.real1_metric_label': 'instead of 6',
    'home.real1_before': '40+ consultants, disconnected tools, spreadsheet tracking. Coordination ate the time they should have spent on their missions.',
    'home.real1_after': 'Integrated application suite. One place for missions, time, deliverables. Consultants do their job — not administration.',
