...
export const ProcessNode = memo(({ data }: NodeProps) => {
  ...
  return (
    <div className="bg-slate-800 rounded-xl border border-blue-500/40 shadow-lg shadow-blue-500/10 px-3.5 py-2.5 min-w-[150px] max-w-[200px] hover:border-blue-400/70 transition-colors">
      <Handle type="target" position={Position.Top} className="!bg-blue-500 !w-2 !h-2 !border-slate-800" />
      ...
      <Handle type="source" position={Position.Bottom} className="!bg-blue-500 !w-2 !h-2 !border-slate-800" />
    </div>
  );
});
